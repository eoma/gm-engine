...
public:
	...
	std::string name;
	bool dirty;
	clan::Signal<unsigned int, const PropertyType &, const PropertyType &> valueChanged;
	clan::Signal<unsigned int, const PropertyType &> valueAdded;
	clan::Signal<unsigned int, const PropertyType &> valueErased;
	clan::Signal<> valuesCleared;
	clan::Signal<unsigned int, unsigned int> listResized;
};
