...
public:
	...
	clan::Signal<void(std::shared_ptr<IPropertyList>)> &property_list_added();
	clan::Signal<void(std::shared_ptr<IPropertyList>, const UserData&)> &property_list_with_user_data_added();
	clan::Signal<void(std::shared_ptr<IPropertyList>)> &property_list_removed();
	clan::Signal<void(std::shared_ptr<IPropertyList>, const UserData&)> &property_list_with_user_data_removed();
...
protected:
	...
	clan::Signal<void(std::shared_ptr<IPropertyList>)> sign_PropertyListAdded;
	clan::Signal<void(std::shared_ptr<IPropertyList>, const UserData&)> sign_PropertyListWithUserDataAdded;
	clan::Signal<void(std::shared_ptr<IPropertyList>)> sign_PropertyListRemoved;
	clan::Signal<void(std::shared_ptr<IPropertyList>, const UserData&)> sign_PropertyListWithUserDataRemoved;
};
